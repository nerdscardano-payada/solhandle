...
export default function Header({ onConnected }) {
  ...
  const links = [["Search", "/"], ["Explore", "/explore"], ["My Handles", "/my-handles"], ["Brand Protection", "/protected-brands"], ["Docs", "/docs"], ...(user?.role === "admin" ? [["Admin", "/admin"]] : [])];
