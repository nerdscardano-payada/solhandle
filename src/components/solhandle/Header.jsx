...
export default function Header({ onConnected }) {
  ...
  const links = [["Search", "/"], ["Explore", "/explore"], ["My Handles", "/my-handles"], ["Share & Earn", "/earn"], ["Brand Protection", "/protected-brands"], ["Integrate", "/integrations"], ["Developers", "/developers"], ["Docs", "/docs"], ...(user?.role === "admin" ? [["Admin", "/admin"]] : [])];
