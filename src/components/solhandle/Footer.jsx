...
export default function Footer() {
  return <footer className="border-t border-violet-400/25 bg-gradient-to-r from-[#070b1c] via-[#17113c] to-[#0a1830] px-5 py-10 text-sm text-slate-300 shadow-[0_-12px_40px_rgba(123,92,255,0.08)] md:px-9">
