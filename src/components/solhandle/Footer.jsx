...
export default function Footer() {
  return <footer className="border-t border-emerald-300/30 bg-gradient-to-r from-[#061914] via-[#073126] to-[#092a30] px-5 py-10 text-sm text-slate-300 shadow-[0_-12px_40px_rgba(45,212,191,0.10)] md:px-9">
