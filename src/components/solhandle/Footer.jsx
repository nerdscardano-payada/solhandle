...
export default function Footer() {
  return <footer className="relative overflow-hidden border-t border-cyan-300/25 bg-[#030615] px-5 py-10 text-sm text-slate-300 shadow-[0_-12px_40px_rgba(45,212,191,0.10)] md:px-9">
    ...
    <div className="relative z-10 mx-auto mt-8 flex max-w-7xl flex-col gap-2 border-t border-white/10 pt-5 text-xs sm:flex-row sm:justify-between"><span>© 2026 SolHandle. Live on Solana Mainnet.</span><div className="flex flex-wrap items-center gap-4"><a href="https://discord.gg/X4UHSTWuk" target="_blank" rel="noreferrer" aria-label="Join the SolHandle Discord" className="inline-flex items-center gap-1.5 font-semibold text-violet-200 hover:text-white"><MessageCircle className="h-4 w-4"/>Discord</a><a href="https://x.com/Solhandle" target="_blank" rel="noreferrer" className="hover:text-cyan-200">X</a><a href="https://magiceden.io/marketplace/solhandle" target="_blank" rel="noreferrer" className="hover:text-cyan-200">Magic Eden</a><Link to="/contact" className="hover:text-cyan-200">Contact</Link></div></div>
  </footer>;
}