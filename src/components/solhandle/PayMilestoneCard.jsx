...
export default function PayMilestoneCard() {
  return <section className="mt-4 rounded-2xl border border-cyan-300/50 bg-slate-950/85 p-5 shadow-xl shadow-cyan-400/10">
    ...
    <Link to="/pay" className="mt-4 inline-flex items-center gap-2 rounded-lg bg-cyan-300 px-4 py-2.5 text-sm font-semibold text-slate-950 hover:bg-cyan-200">Send SOL to an @handle <ArrowRight className="h-4 w-4"/></Link>
  </section>;
}