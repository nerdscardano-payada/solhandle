...
export default function PayMilestoneCard() {
  return <section className="mt-4 rounded-2xl border border-cyan-300/50 bg-slate-950/85 p-5 shadow-xl shadow-cyan-400/10 lg:flex-1">
    ...
    <h2 className="mt-5 text-xl font-semibold text-white">SolHandle Pay</h2>
    ...
    <Link to="/pay" className="mt-4 flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-emerald-300 via-cyan-400 to-violet-500 py-3 font-semibold text-slate-950">Send SOL to an @handle <ArrowRight className="h-4 w-4"/></Link>
  </section>;
}