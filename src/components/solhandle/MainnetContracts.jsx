...
export default function MainnetContracts() {
  ...
  return <section className="relative mt-10 rounded-2xl border border-emerald-300/20 bg-slate-950/60 p-4 backdrop-blur-sm" aria-label="Verified Mainnet contracts">
    ...
    <div className="grid gap-3 md:grid-cols-2">{contracts.map((contract) => <div key={contract.label} className="flex min-w-0 items-center gap-3 rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3">
