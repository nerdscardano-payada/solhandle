...
export default function Growth() {
  ...
  const displayedPriceProgress = c?.price_start_usd ? Math.min(100, Math.floor(Math.max(0, displayedPrice / c.price_start_usd - 1) / (c.price_target_percent / 100) * 100)) : 0;
