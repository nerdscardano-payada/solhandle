...
export default function Roadmap() {
  return <main className="min-h-screen bg-platform text-white"><div className="mx-auto min-h-screen max-w-7xl border-x border-white/10"><Header/><section className="px-5 py-12 md:px-9">
    <p className="text-sm font-medium tracking-wider text-cyan-300">SOLHANDLE MILESTONES</p><h1 className="mt-2 max-w-4xl text-4xl font-semibold md:text-5xl">Built in public. Growing the identity economy.</h1><p className="mt-5 max-w-3xl text-lg leading-relaxed text-slate-300">A clear record of what SolHandle has delivered and the deliberate path from protocol adoption to marketplace activity and token utility.</p>
    <div className="mt-8 grid gap-3 sm:grid-cols-3"><div className="rounded-xl border border-emerald-300/20 bg-emerald-300/5 p-4"><p className="text-xs uppercase tracking-wider text-emerald-300">Delivered</p><p className="mt-2 font-semibold">Mainnet protocol & native marketplace</p></div><div className="rounded-xl border border-cyan-300/20 bg-cyan-300/5 p-4"><p className="text-xs uppercase tracking-wider text-cyan-300">Current focus</p><p className="mt-2 font-semibold">$HANDLE launch & Earn readiness</p></div><div className="rounded-xl border border-violet-300/20 bg-violet-300/5 p-4"><p className="text-xs uppercase tracking-wider text-violet-300">Strategic sequence</p><p className="mt-2 font-semibold">Launch → verify → activate Earn</p></div></div>
