...
export default function TokenLaunchPreview() {
  ...
  return <main className="min-h-screen overflow-hidden bg-[#030615] text-white"><Header /><section className="relative px-5 py-12 md:px-9 md:py-16">
    ...
    <div className="relative mx-auto max-w-6xl"><DemoNotice label={tokenMint ? "Trading live." : "Launch configuration."}>{tokenMint ? "$HANDLE is live. Trade through Jupiter inside SolHandle or use the verified pump.fun route." : "Enter the official CA in the admin dashboard to activate charts and trading."}</DemoNotice>
